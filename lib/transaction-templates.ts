...
As is common practice among companies that operate online, we also allow certain third-party providers to collect information about consumers directly through our websites and other online Services for purposes of analyzing and optimizing our Services, delivering ads, providing content and ads that are more relevant, measuring statistics and the success of ad campaigns, and detecting and reporting fraud. To the extent this practice is interpreted to constitute a "sale" or "sharing" (including for cross-context behavioral advertising) under the CCPA, please refer to the Submitting Requests section below regarding your right to opt-out.

SENSITIVE PERSONAL INFORMATION
Some of the Personal Information described above, such as Payment Information, Government-Issued Identification, or precise Geolocation Data, may constitute "Sensitive Personal Information" under the CCPA. We use and disclose Sensitive Personal Information only for the limited business purposes permitted by the CCPA (such as providing the Services you request, security and fraud prevention, and complying with legal obligations), not to infer characteristics about you. You have the right to limit our use and disclosure of Sensitive Personal Information to those permitted purposes — see the Submitting Requests section below.
...
● The Right to Correct: You have the right to request that we correct inaccurate Personal Information we maintain about you, subject to certain exceptions.

● The Right to Opt-Out of Personal Information Sales and Sharing: You have the right to direct us not to sell or share Personal Information we have collected about you to or with third parties. If you are under the age of 16, you have the right not to have your information sold or shared, unless you, or your parent or guardian, affirmatively authorize such sales or sharing (the "Right to Opt-In").

● The Right to Limit Use of Sensitive Personal Information: To the extent we use or disclose Sensitive Personal Information for purposes other than those permitted by the CCPA, you have the right to direct us to limit that use or disclosure to what's reasonably necessary to perform the Services.
...
To Exercise Your Right to Know, Right to Deletion, Right to Correct, or "Shine the Light" Right. To exercise your right to know, right to deletion, right to correct, or "Shine the Light" right, please submit a request specifying the right you wish to exercise by: emailing ${v.companyEmail} with the subject line "California Rights Request," or calling our toll-free U.S. phone number: ${v.companyPhone}.
...
To Exercise Your Right to Opt-Out of Personal Information Sales and Sharing. To initiate your request to opt out of Personal Information sales and sharing, please click the link below to email us at ${v.companyEmail} with the subject line "California Sale/Sharing Opt-Out" or call our toll-free U.S. phone number at ${v.companyPhone}. To the extent our third-party advertising and analytics providers' collection of information from users of our web sites and other online Services constitutes a "sale" or "sharing" under the CCPA, please refer to our Cookie Notice for more information about the choices and opt-out options you have in relation to those practices. By visiting www.privacyrights.info or www.optout.privacyrights.info, you can also opt out from "sales" and "sharing" of this type of Personal Information by businesses that participate in the DAA's CCPA Opt-Out Tool. To make opt-out requests related to mobile apps on your device for businesses participating in the DAA's CCPA App-based Opt-Out Tool, you can download the appropriate app at www.youradchoices.com/appchoices.

To Exercise Your Right to Limit Use of Sensitive Personal Information. To submit a request to limit our use and disclosure of your Sensitive Personal Information to what's reasonably necessary to perform the Services, please email ${v.companyEmail} with the subject line "Limit Use of Sensitive Personal Information," or call our toll-free U.S. phone number: ${v.companyPhone}.
